...
INSERT INTO thematics (title_fr, title_en, description_fr, description_en, slug, sort_order) VALUES
  ('Terre',
   'Land',
   'Restaurer les terres dégradées, lutter contre la désertification et renforcer la résilience des territoires et des communautés.',
   'Restoring degraded land, combating desertification and strengthening the resilience of territories and communities.',
   'land',
   3);
...
INSERT INTO thematics (title_fr, title_en, description_fr, description_en, slug, sort_order) VALUES
  ('Biodiversité',
   'Biodiversity',
   'Préserver la biodiversité, restaurer les écosystèmes et renforcer leur résilience face aux pressions environnementales.',
   'Preserving biodiversity, restoring ecosystems and strengthening their resilience to environmental pressures.',
   'biodiversity',
   4);
...
INSERT INTO team (name, title_fr, title_en, nationality_fr, nationality_en, image, department) VALUES
  ('Nabil BEN KHATRA',
   'Secrétaire Exécutif',
   'Executive Secretary',
   'Tunisienne', 'Tunisian',
