...
-- ═══════════════════════════════════════════
-- Homepage video (optional singleton, configured from the admin interface)
-- ═══════════════════════════════════════════
...
-- ═══════════════════════════════════════════
-- Recent homepage publication (optional singleton, configured from admin)
-- ═══════════════════════════════════════════
CREATE TABLE IF NOT EXISTS homepage_publication (
    id              SMALLINT PRIMARY KEY DEFAULT 1 CHECK (id = 1),
    title_fr        VARCHAR(255) NOT NULL,
    title_en        VARCHAR(255) NOT NULL,
    ...
    created_at      TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    updated_at      TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    CHECK (url_fr IS NOT NULL OR url_en IS NOT NULL)
);
